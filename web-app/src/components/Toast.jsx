...
const toastIcons = {
  ...
  loading: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="toast-spinner-icon">
...
function ToastItem({ toast }) {
  ...
  return (
    ...
    >
      <span className="toast-icon">{toastIcons[toast.type || 'info']}</span>
